...
public abstract class BooksDatabase extends RoomDatabase {
    ...
    private static RoomDatabase.Callback callBack = new Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            super.onCreate(db);
            new CreateDefaultDataAsyncTask(instance).execute();
        }
    };

    private static class CreateDefaultDataAsyncTask extends AsyncTask<Void,Void,Void>{

        private BookDAO bookDAO;
        private CategoryDAO categoryDAO;

        public CreateDefaultDataAsyncTask(BooksDatabase booksDatabase) {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            categoryDAO.addCategoryData(category1);
            categoryDAO.addCategoryData(category2);
            categoryDAO.addCategoryData(category3);
            ...
            bookDAO.addBookInfo(book2);
            bookDAO.addBookInfo(book3);
            bookDAO.addBookInfo(book4);
            bookDAO.addBookInfo(book5);
            bookDAO.addBookInfo(book6);
            bookDAO.addBookInfo(book7);
            bookDAO.addBookInfo(book8);
            bookDAO.addBookInfo(book9);
            bookDAO.addBookInfo(book10);
            bookDAO.addBookInfo(book11);
            bookDAO.addBookInfo(book12);
            bookDAO.addBookInfo(book13);
            bookDAO.addBookInfo(book14);
            bookDAO.addBookInfo(book15);
            bookDAO.addBookInfo(book16);
